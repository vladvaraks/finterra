            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="{{ route('home') }}" class="flex ms-2 md:me-24">
                        <img src="{{ asset('img/finterra_logo.jpg') }}" class="h-8 me-3" alt="Финтерра" />
                    </a>
                </div>
                <div class="flex items-center">
                    <div class="flex items-center ms-3">
                        <div>
                            <button type="button"
                                class="flex text-sm rounded-full focus:ring-2 focus:ring-fuchsia-600 dark:focus:ring-fuchsia-600"
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Переводы</span>
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ route('transfer') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Запланировать перевод</a>
                        </li>
                    </ul>
                </li>
            </ul>
